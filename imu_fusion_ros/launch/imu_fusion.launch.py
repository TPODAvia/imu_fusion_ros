...
def generate_launch_description():
    ...
    use_gravity_compensated_accel = parse_bool_env("GRAVITY_COMPENSATED_ACCEL", "True") 
    map_frame_id      = parse_str_env("MAP_FRAME_ID", "map")
    target_frame_id   = parse_str_env("TARGET_FRAME_ID", "base_link")
    imu_raw_topic     = parse_str_env("IMU_RAW_TOPIC", "mavros/imu/data_raw")
    mag_topic         = parse_str_env("MAG_TOPIC", "mavros/imu/mag")
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[
                ...
                {'use_gravity_compensated_accel': use_gravity_compensated_accel},
